...
mixin _$FormStore on _FormStore, Store {
  ...
  late final _$colorAtom = Atom(name: '_FormStore.color', context: reactiveContext);
  ...
  late final _$nameAtom = Atom(name: '_FormStore.name', context: reactiveContext);
  ...
  late final _$emailAtom = Atom(name: '_FormStore.email', context: reactiveContext);
  ...
  late final _$passwordAtom =
      Atom(name: '_FormStore.password', context: reactiveContext);
  ...
  late final _$usernameCheckAtom =
      Atom(name: '_FormStore.usernameCheck', context: reactiveContext);
  ...
  late final _$validateUsernameAsyncAction =
      AsyncAction('_FormStore.validateUsername', context: reactiveContext);
  ...
  late final _$_FormStoreActionController =
      ActionController(name: '_FormStore', context: reactiveContext);
...
mixin _$FormErrorState on _FormErrorState, Store {
  ...
  late final _$usernameAtom =
      Atom(name: '_FormErrorState.username', context: reactiveContext);
  ...
  late final _$emailAtom =
      Atom(name: '_FormErrorState.email', context: reactiveContext);
  ...
  late final _$passwordAtom =
      Atom(name: '_FormErrorState.password', context: reactiveContext);
