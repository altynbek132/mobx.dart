...
mixin _$TodoList on _TodoList, Store {
  ...
  late final _$todosAtom = Atom(name: '_TodoList.todos', context: reactiveContext);
  ...
  late final _$filterAtom = Atom(name: '_TodoList.filter', context: reactiveContext);
  ...
  late final _$_TodoListActionController =
      ActionController(name: '_TodoList', context: reactiveContext);
