...
mixin _$GithubStore on _GithubStore, Store {
  ...
  late final _$fetchReposFutureAtom =
      Atom(name: '_GithubStore.fetchReposFuture', context: reactiveContext);
  ...
  late final _$userAtom = Atom(name: '_GithubStore.user', context: reactiveContext);
  ...
  late final _$fetchReposAsyncAction =
      AsyncAction('_GithubStore.fetchRepos', context: reactiveContext);
  ...
  late final _$_GithubStoreActionController =
      ActionController(name: '_GithubStore', context: reactiveContext);
